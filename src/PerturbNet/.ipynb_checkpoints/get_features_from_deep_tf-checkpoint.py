...
def get_data(model_path, df_path, cell_types, compounds, genes, get_target=True):
...
def main():
    ...
    for cell_type in ['nk', 't_cd4', 't_cd8', 't_reg']:
        ...
        # training data
        df_train = f'../../results/deep_tensor_factorization/df_train_{cell_type}.csv'
        ...
        # validation data
        df_valid = f'../../results/deep_tensor_factorization/df_valid_{cell_type}.csv'
        x, y, cell_type_idxs, compound_idxs, gene_idxs = get_data(model_path=model_path,
                                                                df_path=df_valid,
                                                                cell_types=cell_types,
                                                                compounds=compounds,
